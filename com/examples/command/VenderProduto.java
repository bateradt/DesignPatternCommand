...
/**
 * Classe cuja função é representar o comando "VenderProduto", ou seja,
 * registrar venda de produtos no estoque. Essa classe implementa a interface
 * IPedido, que apresenta o método de execução do comando (Execute)
 */
...
public class VenderProduto implements IPedido {
	 ...
	 * método de venda de produtos da classe Produto e imprime no console uma
